    ...
    <div id="pageContent">
		...
		*/ ?>
            ...
            <div class="contentBox" id="customInstall">
                ...
                <pre>&lt;script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"&gt;&lt;/script&gt;<br/>&lt;script type="text/javascript" src="path/to/resources/colorbox/jquery.colorbox.js"&gt;&lt;/script&gt;</pre>
